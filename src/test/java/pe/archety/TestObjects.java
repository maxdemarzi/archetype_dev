...
public class TestObjects {
    ...
    public static final String validURL3 = "http://en.wikipedia.org/wiki/Marshmallow";
    public static final String invalidWikipediaURL = "http://en.notwikipedia.org/wiki/Neo4j";
    public static final String validLinkedURL = "http://en.wikipedia.org/wiki/Graph_database";
    public static final String validLinkedURL2 = "http://en.wikipedia.org/wiki/NoSQL";
