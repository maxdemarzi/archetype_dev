...
public class PageTest {
    ...
    @Test
    public void shouldValidateLinkedPages() {
        assertTrue(Page.isValidPageLink(validURL, validLinkedURL));
    }

    @Test
    public void shouldThrowBecauseOfwikipediaPagesNotLinked() throws IOException {
        thrown.expect(pe.archety.Exception.class);
        thrown.expectMessage(Exception.wikipediaPagesNotLinked.getMessage());
        Page.isValidPageLink(validURL, validURL2);
    }
